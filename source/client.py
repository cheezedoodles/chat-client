...
from key_generator import generate_files
...
class ChatThread(QObject, threading.Thread):
    ...
    async def receiver(self):
        async with websockets.connect(
            WEBSOCKET_URL + f"{self.chat_id}/{self.username}/",
            origin=ORIGIN,
...
class ChatWidget(QWidget):
    ...
    def receive_message(self):
        ...
        self.key = generate_key(self.chat_num, encrypted_message, self.offset)
    ...
    def get_chat_messages(self):
        ...
        for _, message in enumerate(chat_history):
            ...
            key = generate_key(self.chat_num, message["message"], current_offset)
    ...
    def send_message(self):
        ...
        self.key = generate_key(self.chat_num, send_value, self.offset)
